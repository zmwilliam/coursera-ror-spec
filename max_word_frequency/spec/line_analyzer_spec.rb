...
describe LineAnalyzer do
  ...
  context "#calculate_word_frequency_ignoring_case" do
    subject(:lineAnalyzer) {LineAnalyzer.new("Will it work maybe it will work do you think it will it will", 1)}
    
    it "highest_wf_count value is 4" do
      expect(lineAnalyzer.highest_wf_count).to eq(4)
    end

    it "highest_wf_words include \"will and it\"" do
